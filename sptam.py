...
class SPTAM(object):
    def __init__(self, params):
        ...
        self.tracker = Tracking(params)    # Defines optimization (bundle-adjustment) for tracking and pose refinement
    ...
    def track(self, frame):
        ...
        frame.update_pose(predicted_pose)  # updates pose using previous pose and 
        								   # linear velocity
        if self.loop_closing is not None:
...
if __name__ == '__main__':
    ...
    cam = Camera(
        ...
        dataset.cam.baseline)						# Initialize camera object with focal lenghts, image center, width,
    												# height, etc
    ...
    for i in range(len(dataset))[:100]:
        ...
        # Not sure what g2o.isometry3d() is, most probably it is (x, y, z, roll, pitch and yaw)
